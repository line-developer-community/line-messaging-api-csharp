...
namespace LineDC.Messaging
{
    ...
    public interface ILineMessagingClient
    {
        ...
        /// <summary>
        /// Retrieve image, video, and audio data sent by users as <see cref="System.Net.Http.HttpContent"/>
        /// https://developers.line.me/en/docs/messaging-api/reference/#get-content
        /// </summary>
        /// <param name="messageId">Message ID</param>
        /// <returns><see cref="System.Net.Http.HttpContent"/></returns>
        Task<HttpContent> GetContentAsync(string messageId);
        ...
        Task<GroupMemberIdsResponse> GetGroupMemberIdsAsync(string groupId, string continuationToken);
        ...
        /// <param name="continuationToken">ContinuationToken</param>
        /// <returns>GroupMemberIds</returns>
        Task<GroupMemberIdsResponse> GetRoomMemberIdsAsync(string roomId, string continuationToken = null);
        ...
        Task<HttpContent> DownloadRichMenuImageAsync(string richMenuId);
